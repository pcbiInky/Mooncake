...
// Runs coalesced callbacks on a dedicated thread, optionally at a fixed period.
// The owner serializes Start/Stop; Schedule is thread-safe.
class BackgroundWorker {
   public:
    ...
    // Restarts the periodic wait with a new interval.
